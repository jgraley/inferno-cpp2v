...
wait(SC_ZERO_TIME);
{
state=(((0)==switch_value1) ? (lmap[ ::TopLevel::T_STATE_CASE]) : (lmap[ ::TopLevel::T_STATE_PROCEED2]));
goto *(state);
}
PROCEED:;
{
state=(((4)==switch_value1) ? (lmap[ ::TopLevel::T_STATE_CASE2]) : (lmap[ ::TopLevel::T_STATE_PROCEED3]));
goto *(state);
}
PROCEED1:;
{
...
switch_value=(2);
{
state=(((2)==switch_value) ? (lmap[ ::TopLevel::T_STATE_CASE1]) : (lmap[ ::TopLevel::T_STATE_PROCEED]));
goto *(state);
}
PROCEED2:;
{
...
CASE2:;
{
state=((!(((0)== ::TopLevel::x)||((2)== ::TopLevel::x))) ? (lmap[ ::TopLevel::T_STATE_THEN_ELSE_BREAK]) : (lmap[ ::TopLevel::T_STATE_PROCEED4]));
goto *(state);
}
PROCEED3:;
{
state=((!(false)) ? (lmap[ ::TopLevel::T_STATE_THEN]) : (lmap[ ::TopLevel::T_STATE_PROCEED1]));
goto *(state);
}
PROCEED4:;
muxtemp=(88);
