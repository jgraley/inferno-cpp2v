...
{
state=(((4)==switch_value) ?  ::TopLevel::T_STATE_CASE_2 :  ::TopLevel::T_STATE_PROCEED_2);
}
...
{
switch_value_1=(2);
state=(((2)==switch_value_1) ?  ::TopLevel::T_STATE_CASE_1 :  ::TopLevel::T_STATE_PROCEED_4);
}
...
{
state=((!(((0)== ::TopLevel::x)||( ::TopLevel::x==(2)))) ?  ::TopLevel::T_STATE_THEN_ELSE_BREAK :  ::TopLevel::T_STATE_PROCEED_1);
}
