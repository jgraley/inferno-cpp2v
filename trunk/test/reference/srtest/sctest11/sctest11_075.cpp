...
if(  ::TopLevel::state== ::TopLevel::T_STATE_LINK2 )
{
 ...
 ::TopLevel::muxtemp=( ::TopLevel::y-= ::TopLevel::result2);
 ::TopLevel::state= ::TopLevel::T_STATE_ELSE;
}
if(  ::TopLevel::state== ::TopLevel::T_STATE_ELSE )
{
 ::TopLevel::result5= ::TopLevel::muxtemp;
 ::TopLevel::result5;
