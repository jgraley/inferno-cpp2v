...
public:	
	...
	virtual TreePtr<Node> OnParseEmbedded( TreePtr<Node> node, VNLangActions *vn ); // return NULL if cannot decay 
...
public:	
	...
	TreePtr<Node> OnParseEmbedded( TreePtr<Node> node, VNLangActions *vn ) final; 
