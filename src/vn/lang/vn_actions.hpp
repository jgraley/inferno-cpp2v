...
public:
	...
	TreePtr<Node> OnTypeAndAbstractDeclarator( TreePtr<Node> type, TreePtr<Node> declarator, any declarator_loc );	
	TreePtr<Node> OnParameter( TreePtr<Node> type, TreePtr<Node> declarator, any declarator_loc );	
	TreePtr<Node> OnAbstractParameter( TreePtr<Node> type, TreePtr<Node> declarator, any declarator_loc );	
