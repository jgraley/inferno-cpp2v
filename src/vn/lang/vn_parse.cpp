...
Production VNParse::OnBuiltIn( list<string> builtin_type, any builtin_loc, Itemisation src_itemisation )
{
...
// Exceptions
// Better errors with builtins (means custom types)
...
// It's ⚬ not ⨟ for itemisations, which means ⨟ can imply commands
//    or should ⚬ be instead of comma ?
// Read https://savannah.gnu.org/news/?id=9699 about syntax error messages

// Centralise your wstring conversions
// In error messages, quote all excerpts from user code the way GCC does it
// ...so, perhaps helper functions for both

// Parsing 130-LowerSCType.vn reveals a mis-render - the identifier should be rendered with some kind of "real identifier" syntax (and its name hint)
