...
ExplicitiseReturns::ExplicitiseReturns()
{
    ...
    auto ms_affected = MakePatternNode<NegationAgent, StmtDecl>();
    ...
    auto embedded_l = MakePatternNode<EmbeddedSearchReplaceAgent, Compound>( embedded_m, ls_return, lr_assign);
