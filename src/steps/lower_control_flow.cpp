...
ForToWhile::ForToWhile()
{
    ...
    auto r_cont_labelid = MakePatternNode<SpecificLabelIdentifier>("CONTINUE");
...
IfToIfGoto::IfToIfGoto()
{
    ...
    auto r_labelid1 = MakePatternNode<SpecificLabelIdentifier>("THEN");
    auto r_labelid2 = MakePatternNode<SpecificLabelIdentifier>("ELSE");
...
SwitchToIfGoto::SwitchToIfGoto()
{
    ...
    auto l1_r_labelid = MakePatternNode<SpecificLabelIdentifier>("DEFAULT");
    ...
    auto l2_r_labelid = MakePatternNode<SpecificLabelIdentifier>("CASE");
    ...
    auto l3_r_labelid = MakePatternNode<SpecificLabelIdentifier>("CASE");
...
DoToIfGoto::DoToIfGoto()
{
    ...
    auto r_nop = MakePatternNode<Nop>();
    auto r_comp = MakePatternNode<Compound>();
    auto r_labelid = MakePatternNode<SpecificLabelIdentifier>("NEXT");
    auto l_r_cont_labelid = MakePatternNode<SpecificLabelIdentifier>("CONTINUE");
...
BreakToGoto::BreakToGoto()
{
    ...
    auto s_break = MakePatternNode<Break>();
    auto r_goto = MakePatternNode<Goto>();
    auto r_labelid = MakePatternNode<SpecificLabelIdentifier>("BREAK");
    auto r_label = MakePatternNode<Label>();
    auto r_comp = MakePatternNode<Compound>();
