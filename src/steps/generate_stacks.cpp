...
UseTempForReturnValue::UseTempForReturnValue()
{
    ...
    auto cs_id = MakePatternNode< TransformOf<InstanceIdentifier> >( &GetDeclaration::instance );
...
AddLinkAddress::AddLinkAddress()
{
    ...
    auto m_any = MakePatternNode< AnyNode<Statement> >(); // TODO rename AnyNode -> Blob
    ...
    auto ll_any = MakePatternNode< AnyNode<Statement> >();
