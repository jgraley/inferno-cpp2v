...
class AutosToModule : public VNStep
{
public:
    AutosToModule();
};
...
class TempsAndStaticsToModule : public VNStep
{
public:
...
class DeclsToModule : public VNStep
{
public:
    DeclsToModule();
};
...
class ThreadToMethod : public VNStep
{
public:
    ThreadToMethod();
};
...
/// loops not supported.
class ExplicitiseReturns : public VNStep
{
public:
    ExplicitiseReturns();
};
