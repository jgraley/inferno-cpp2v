...
const XLink XLink::OffEndXLink = XLink::CreateDistinct( MakeTreePtr<XLink::OffEnd>() );
const XLink XLink::UndefinedXLink = XLink::CreateDistinct( MakeTreePtr<XLink::Undefined>() );
