...
void DeltaAgent::StartPlanOverlay( map<PatternLink, PatternLink> &overlay_plinks )
{
    ASSERT( *GetOverlay() );          
    ...
    overlay_plink.GetChildAgent()->PlanOverlay(overlay_plinks, overlay_plink, through_plink);
}
